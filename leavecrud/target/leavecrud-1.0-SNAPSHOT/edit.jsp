...
<div class="container main-container">
  ...
  <form id="editVenueForm">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="name" name="name" value="${venue.name}" required pattern="^[A-Za-z0-9\s\-.,&()]{3,100}$">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="location" name="location" value="${venue.location}" required pattern="^[A-Za-z0-9\s\-.,]{3,100}$">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" id="facilities" name="facilities" rows="3" required minlength="50">${venue.facilities}</textarea>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="date" class="form-control" id="availableFrom" name="availableFrom"
                 value="<fmt:formatDate value="${venue.availableFrom}" pattern="yyyy-MM-dd" />" required>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="date" class="form-control" id="availableTo" name="availableTo"
                 value="<fmt:formatDate value="${venue.availableTo}" pattern="yyyy-MM-dd" />" required>
  ...
  <div class="mt-4 text-center text-muted">
    <small>Venue Management System powered by <a href="https://www.oracle.com/java/technologies/" class="text-decoration-none">Java</a></small>
  </div>
</div>
...
<script>
  function submitEditForm() {
    ...
    // Send request
    fetch('${pageContext.request.contextPath}/venues/' + venueId, {
      method: 'PUT',
      headers: {
      ...
      body: JSON.stringify(venueData)
            ...
            .catch(error => {
              ...
              if (typeof Swal !== 'undefined') {
                Swal.fire({
                  title: 'Error!',
                  text: 'Failed to update venue: ' + error.message,
                  icon: 'error',
                  confirmButtonColor: '#2c3e50'
                });
              } else {
  ...
  document.querySelectorAll('#editVenueForm input, #editVenueForm textarea').forEach(input => {
